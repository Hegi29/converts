...
test('(Quadrillion) converts results 123.123.123.123.123.123.45 should be “ ONE HUNDRED AND TWENTY-THREE QUADRILLION ONE HUNDRED AND TWENTY-THREE TRILLION ONE HUNDRED AND TWENTY-THREE BILLION ONE HUNDRED AND TWENTY-THREE MILLION ONE HUNDRED AND TWENTY-THREE THOUSAND ONE HUNDRED AND TWENTY-THREE DOLLARS AND FORTY-FIVE CENTS ”', () => {
  render(<App />);
  ...
  const resultText = screen.getByTestId(/result/i).textContent;

  expect(resultText).toBe(`" ONE HUNDRED AND TWENTY-THREE QUADRILLION ONE HUNDRED AND TWENTY-THREE TRILLION ONE HUNDRED AND TWENTY-THREE BILLION ONE HUNDRED AND TWENTY-THREE MILLION ONE HUNDRED AND TWENTY-THREE THOUSAND ONE HUNDRED AND TWENTY-THREE DOLLARS AND FORTY-FIVE CENTS "`);
});
...
test('(Quintillion) converts results 123.123.123.123.123.123.123.45 should be “ ONE HUNDRED AND TWENTY-THREE QUINTILLION ONE HUNDRED AND TWENTY-THREE QUADRILLION ONE HUNDRED AND TWENTY-THREE TRILLION ONE HUNDRED AND TWENTY-THREE BILLION ONE HUNDRED AND TWENTY-THREE MILLION ONE HUNDRED AND TWENTY-THREE THOUSAND ONE HUNDRED AND TWENTY-THREE DOLLARS AND FOURTY-FIVE CENTS ”', () => {
  ...
  expect(resultText).toBe(`" ONE HUNDRED AND TWENTY-THREE QUINTILLION ONE HUNDRED AND TWENTY-THREE QUADRILLION ONE HUNDRED AND TWENTY-THREE TRILLION ONE HUNDRED AND TWENTY-THREE BILLION ONE HUNDRED AND TWENTY-THREE MILLION ONE HUNDRED AND TWENTY-THREE THOUSAND ONE HUNDRED AND TWENTY-THREE DOLLARS AND FOURTY-FIVE CENTS "`);
});
...
test('(Sextillion) converts results 123.123.123.123.123.123.123.123.45 should be “ ONE HUNDRED AND TWENTY-THREE SEXTILLION ONE HUNDRED AND TWENTY-THREE QUINTILLION ONE HUNDRED AND TWENTY-THREE QUADRILLION ONE HUNDRED AND TWENTY-THREE TRILLION ONE HUNDRED AND TWENTY-THREE BILLION ONE HUNDRED AND TWENTY-THREE MILLION ONE HUNDRED AND TWENTY-THREE THOUSAND ONE HUNDRED AND TWENTY-THREE DOLLARS AND FOURTY-FIVE CENTS ”', () => {
  ...
  expect(resultText).toBe(`" ONE HUNDRED AND TWENTY-THREE SEXTILLION ONE HUNDRED AND TWENTY-THREE QUINTILLION ONE HUNDRED AND TWENTY-THREE QUADRILLION ONE HUNDRED AND TWENTY-THREE TRILLION ONE HUNDRED AND TWENTY-THREE BILLION ONE HUNDRED AND TWENTY-THREE MILLION ONE HUNDRED AND TWENTY-THREE THOUSAND ONE HUNDRED AND TWENTY-THREE DOLLARS AND FOURTY-FIVE CENTS "`);
});
